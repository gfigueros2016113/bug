    ...
    $.ajax({
        ...
        success: function (idUsuario) {
            $.ajax({
                ...
                success: function (respuesya) {
                    let lista = JSON.parse(respuesya);
                    lista.forEach(lista => {
                        if (lista.id_empresa == 1) {
                            ...
                            document.getElementById("color_usuario").className = "card-header p-4 p-md-5 border-bottom-0 bg-gradient-danger text-white-50";
                        }
                        else {
                            document.getElementById("accordionSidebar").className = "navbar-nav bg-gradient-primary sidebar sidebar-dark accordion toggled";
                            document.getElementById("color_usuario").className = "card-header p-4 p-md-5 border-bottom-0 bg-gradient-primary-to-secondary text-white-50";
                        }
                    });
                }
            });
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            list.forEach(list => {
                ...
                document.getElementById('cliente').innerHTML = list.cliente;
